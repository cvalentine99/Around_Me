#!/bin/bash
# VALENTINE RF - Multi-architecture Docker image builder
#
...
#   IMAGE_NAME  - Image name (default: valentine-rf)
...
# Configuration
REGISTRY="${REGISTRY:-}"
IMAGE_NAME="${IMAGE_NAME:-valentine-rf}"
IMAGE_TAG="${IMAGE_TAG:-latest}"
BUILDER_NAME="valentine-builder"
...
for arg in "$@"; do
    case $arg in
        ...
        --help|-h)
            ...
            echo "  IMAGE_NAME  Image name (default: valentine-rf)"
...
echo "============================================"
echo "  VALENTINE RF Multi-Architecture Builder"
echo "============================================"
