#!/usr/bin/env python3
"""
Integration tests for Valentine RF Agent with real tools.
...
def agent():
    ...
    from valentine_agent import ModeManager
    return ModeManager()
...
class TestAirodumpParsing:
    """Tests for airodump-ng CSV parsing using Valentine RF's parser."""

    def test_valentine_parser_available(self):
        """Valentine RF's airodump parser should be importable."""
        from utils.wifi.parsers.airodump import parse_airodump_csv
        assert callable(parse_airodump_csv)

    def test_parse_csv_networks_with_valentine_parser(self, temp_csv_file):
        """Valentine RF parser should parse network section of CSV."""
        from utils.wifi.parsers.airodump import parse_airodump_csv
    ...
    def test_parse_csv_clients_with_valentine_parser(self, temp_csv_file):
        """Valentine RF parser should parse client section of CSV."""
        from utils.wifi.parsers.airodump import parse_airodump_csv
    ...
    def test_agent_uses_valentine_parser(self, agent, temp_csv_file):
        """Agent should use Valentine RF's parser when available."""
...
class TestGPSIntegration:
    ...
    def test_gps_position_format(self):
        ...
        from valentine_agent import GPSManager
