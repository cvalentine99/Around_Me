"""Configuration settings for Valentine RF application."""
...
def _get_env(key: str, default: str) -> str:
    ...
    return os.environ.get(f'VALENTINE_{key}', default)


def _get_env_int(key: str, default: int) -> int:
    """Get environment variable as integer with default."""
    try:
        return int(os.environ.get(f'VALENTINE_{key}', str(default)))
    except ValueError:
        return default
...
def _get_env_float(key: str, default: float) -> float:
    ...
    try:
        return float(os.environ.get(f'VALENTINE_{key}', str(default)))
    except ValueError:
        return default
...
def _get_env_bool(key: str, default: bool) -> bool:
    ...
    val = os.environ.get(f'VALENTINE_{key}', '').lower()
...
ADSB_DB_NAME = _get_env('ADSB_DB_NAME', 'valentine_adsb')
ADSB_DB_USER = _get_env('ADSB_DB_USER', 'valentine')
ADSB_DB_PASSWORD = _get_env('ADSB_DB_PASSWORD', 'valentine')
...
# Update checking
GITHUB_REPO = _get_env('GITHUB_REPO', 'smittix/valentine-rf')
