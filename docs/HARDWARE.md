...
VALENTINE RF automatically detects connected devices.
...
### Check dependencies
```bash
python3 valentine-rf.py --check-deps
```
...
# Custom port
VALENTINE_PORT=8080 sudo -E venv/bin/python valentine-rf.py
```
