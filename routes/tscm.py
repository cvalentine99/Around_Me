...
logger = logging.getLogger('valentine.tscm')
...
def get_tscm_devices():
    ...
    if not running_as_root:
        warnings.append({
            ...
            'action': 'Run with: sudo -E venv/bin/python valentine.py'
        })
...
def get_findings():
    ...
    findings['legal_disclaimer'] = (
        ...
        "surveillance devices. No content has been captured or decoded. Findings "
    ...
    report = {
        ...
        'disclaimers': {
            'legal': (
                ...
                "captured, recorded, or decoded. This screening does not prove "
