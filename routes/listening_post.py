...
logger = get_logger('valentine.listening_post')
...
async def stream_scanner_events() -> Response:
    ...
    def _on_listening_scanner_msg(msg):
        try:
    ...
    response = Response(
        async_sse_stream_fanout(
            ...
            on_message=_on_listening_scanner_msg,
        ),
...
async def stream_waterfall() -> Response:
    ...
    response = Response(
        async_sse_stream_fanout(
            ...
            channel_key='waterfall',
            on_message=_on_waterfall_msg,
        ),
        mimetype='text/event-stream',
    )
    response.headers['Cache-Control'] = 'no-cache'
