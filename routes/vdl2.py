...
from utils.sse import async_sse_stream_fanout, format_sse
...
@vdl2_bp.route('/tools')
async def check_vdl2_tools() -> Response:
...
async def vdl2_status() -> Response:
...
async def stream_vdl2() -> Response:
