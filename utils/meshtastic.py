...
allowing VALENTINE RF to receive and decode messages from LoRa mesh networks.
...
logger = get_logger('valentine.meshtastic')
    ...
    def check_firmware(self) -> dict:
        ...
        if not cache_valid:
            try:
                ...
                req = urllib.request.Request(url, headers={'User-Agent': 'VALENTINE RF'})
