...
logger = logging.getLogger('valentine.aircraft_db')
...
def check_for_updates() -> dict[str, Any]:
    ...
    try:
        req = Request(GITHUB_API_URL, headers={'User-Agent': 'Valentine RF-SIGINT'})
...
def download_database(progress_callback=None) -> dict[str, Any]:
    ...
    try:
        ...
        req = Request(AIRCRAFT_DB_URL, headers={'User-Agent': 'Valentine RF-SIGINT'})
        ...
        req = Request(TYPES_DB_URL, headers={'User-Agent': 'Valentine RF-SIGINT'})
