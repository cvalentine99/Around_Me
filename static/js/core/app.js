/**
 * Valentine RF - Core Application Logic
...
function toggleTheme() {
    ...
    localStorage.setItem('valentine-theme', newTheme);
...
function loadTheme() {
    const savedTheme = localStorage.getItem('valentine-theme') || 'dark';
...
function showInfo(text) {
    ...
    infoEl.style.cssText = 'padding: 12px 15px; margin-bottom: 8px; background: #08060e; border: 1px solid #120f1e; border-left: 2px solid #a78bfa; font-family: "Space Mono", monospace; font-size: 11px; color: #888; word-break: break-all;';
