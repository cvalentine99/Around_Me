...
window.ObserverLocation = (function() {
    const DEFAULT_LOCATION = (window.VALENTINE_DEFAULT_LAT && window.VALENTINE_DEFAULT_LON)
        ? { lat: window.VALENTINE_DEFAULT_LAT, lon: window.VALENTINE_DEFAULT_LON }
    ...
    function isSharedEnabled() {
        return window.VALENTINE_SHARED_OBSERVER_LOCATION !== false;
    }
